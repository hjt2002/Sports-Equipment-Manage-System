          ...
          {{msg}}
            ...
            >
              <el-form-item label="UID">
                <el-input v-model="borrow_data.UID" />
              </el-form-item>
              <el-form-item label="EID">
                <el-input v-model="borrow_data.EID" />
              </el-form-item>


              <el-form-item label="borrowTime">
                <el-col :span="11">
                  <el-date-picker
                      v-model="borrow_data.borrowTime"
                      type="date"
                      label="Pick a date"
              ...
              <el-form-item label="returnTime">
                <el-col :span="11">
                  <el-date-picker
                      v-model="borrow_data.returnTime"
                      type="date"
                      label="Pick a date"
                      placeholder="Pick a date"
                      style="width: 100%"
              ...
              <el-form-item>
                <el-button class="my_button" @click="onSubmit">确定</el-button>
              </el-form-item>
            </el-form>
